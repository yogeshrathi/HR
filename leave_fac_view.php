				...
				<!-- /Page Title -->
					...
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">LEAVES</h3>
							<div class="table-div">
								<table class="table table-hover">
									<thead>
										<tr>
											<th scope="col">NAME</th>
											<th scope="col">PL AVALIABLE</th>
											<th scope="col">PL USED</th>
											<th scope="col">CL AVALIABLE</th>
											<th scope="col">CL USED</th>
										    <th scope="col">SL AVALIABLE</th>
											<th scope="col">SL USED</th>
											<th scope="col">TOTAL_LEAVE_AVL</th>
											<th scope="col">TOTAL_USED</th>
									...
									<tbody>
									  ...
									  echo "<tr><td>".$row1["name"]."</td><td>".$row1["pl_avl"]."</td><td>".$row1["pl_used"]."</td><td>".$row1["cl_avl"]."</td><td>".$row1["cl_used"]."</td><td>".$row1["el_avl"]."</td><td>".$row1["el_used"]."</td><td>".$row1["total_leave_avl"]."</td><td>".$row1["total_leave_used"]."</td>";?></tr> 
									<?php 
								}
								?>
									</tbody>
