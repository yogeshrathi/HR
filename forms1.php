	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">OFFICAL_DETAILS</li>
			</ol><!-- /Breadcrumb -->
			<!-- Main Content -->
			<div class="container-fluid">
				<!-- Page Title -->
					...
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							...
							<div class="lorvens-widget">
								<form action="form_back2.php" method="POST">
									<div class="form-group">
										<label for="exampleInputEmail1">QUALIFICATION</label>
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter qualifications " name="quali" value="<?php
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter experience " name="exp" value="<?php
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter post " name="post" value="<?php
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter salary " name="salary" value="<?php
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter joining date " name="jdate" value="<?php
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter adhar no " name="adrno" value="<?php

										echo 
										$row['ADHAR_NO'];?>">
									<div class="form-group">
										<label for="exampleInputEmail1">PANCARD NO</label>
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter pancard no " name="panno"
										value="<?php
									...
									<div class="form-group">
										...
										<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter acoount no " name="accno" value="<?php

										echo 
										$row['BANK_ACC_NO'];?> " >
									</div>
									<div class="form-group">
										<label for="exampleInputEmail1">ELECTION CARD NO</label>
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter election card no " name="eleno" value="<?php
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter IFSC code " name="ifsc" value="<?php
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter bank location " name="bankloc"
										value="<?php
									...
									<div class="form-group">
										<label for="exampleInputEmail1">ACCCOUNT TYPE</label>
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter account type " name="acctype"
										value="<?php
									...
									<div class="form-group">
										<label for="exampleInputEmail1">ALLOCATED EQUIPMENTS</label>
										<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter equipments " name="eqp"
										value="<?php
